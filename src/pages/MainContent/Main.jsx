  ...
  return (
    <main>
      ...
      <ul className="box-info">
        <li><i className="icon"><CalendarCheck className='blue' style={{color: "blue"}}/></i><span className="text"><h3>{orders.length}</h3><p>Total Orders</p></span></li>
        <li><i className="icon"><Users className='blue' style={{color: "blue"}}/></i><span className="text"><h3>{totalViews}</h3><p>Visitors</p></span></li>
        <li><i className="icon"><DollarSign className='blue' style={{color: "blue"}} /></i><span className="text"><h3>{totalBudget}frs</h3><p>Total Sales</p></span></li>
      </ul>
